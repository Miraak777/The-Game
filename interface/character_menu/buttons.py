...
from core.constants.path_constants import BUTTONS


def create_strength_adding_button(self) -> QPushButton:
    strength_adding_button = QPushButton()
    strength_adding_button.setStyleSheet(self._add_button_stylesheet)
...
def create_agility_adding_button(self) -> QPushButton:
    ...
    agility_adding_button.setStyleSheet(self._add_button_stylesheet)
...
def create_vitality_adding_button(self) -> QPushButton:
    ...
    vitality_adding_button.setStyleSheet(self._add_button_stylesheet)
...
def create_endurance_adding_button(self) -> QPushButton:
    ...
    endurance_adding_button.setStyleSheet(self._add_button_stylesheet)
...
def create_strength_removing_button(self) -> QPushButton:
    ...
    strength_removing_button.setStyleSheet(self._remove_button_stylesheet)
...
def create_agility_removing_button(self) -> QPushButton:
    ...
    agility_removing_button.setStyleSheet(self._remove_button_stylesheet)
...
def create_vitality_removing_button(self) -> QPushButton:
    ...
    vitality_removing_button.setStyleSheet(self._remove_button_stylesheet)
...
def create_endurance_removing_button(self) -> QPushButton:
    ...
    endurance_removing_button.setStyleSheet(self._remove_button_stylesheet)
...
def create_accept_button(self) -> QPushButton:
    ...
    accept_button.setStyleSheet(self._accept_button_stylesheet)
