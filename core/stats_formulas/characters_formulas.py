...
def min_damage_formula(
    min_damage, agility, agility_damage_multiplier, strength, strength_damage_multiplier
):
    return min_damage * (
...
def max_damage_formula(
    max_damage, agility, agility_damage_multiplier, strength, strength_damage_multiplier
):
    return max_damage * (
        (agility_damage_multiplier * (1 + agility * 0.1))
        + (strength_damage_multiplier * (1 + strength * 0.1))
...
def critical_strike_formula(
    base_critical_strike_chance, agility, critical_strike_chance_multiplier
):
